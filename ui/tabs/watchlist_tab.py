...
class Tab(QtWidgets.QWidget):
    def __init__(self):
        ...
        sidebar_items = ['Active List', 'Create List', 'Price Alerts', 'Volume Alerts', 'Technical Alerts', 'History']
        ...
        self.content_label = QtWidgets.QLabel("Content for Watchlist Tab.Py")
